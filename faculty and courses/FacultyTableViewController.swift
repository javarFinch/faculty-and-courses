...
class FacultyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = faculty.firstName + " " + faculty.lastName + ", " + faculty.degree
        cell.detailTextLabel?.text = faculty.title
        title = "CEC Faculty"
        //cell.imageView?.image = UIImage(named: "mitrof.jpg")
        cell.imageView?.image = UIImage(named: faculty.userName + ".jpg")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let dvc = segue.destination as! FacultyDetailsViewController
        let indexPath = tableView.indexPathForSelectedRow
        let faculty = facultyResponse.faculty[(indexPath?.row)!]
        dvc.facultyDetails = faculty
    }
